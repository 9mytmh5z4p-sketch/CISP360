...
## Is there a cleaner way to handle<br> multiple equality comparisons?
...
Here's a full program using a switch statement to process a menu choice. This demonstrates a typical use case: menu-driven program where switch makes the intent clear. Note the braces around each case that declares variables.
