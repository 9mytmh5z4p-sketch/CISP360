...
"$python_command" -m http.server "$port" --bind 127.0.0.1 >/private/tmp/p360-syllabus-preview.log 2>&1 &
server_pid=$!
...
open "http://127.0.0.1:${port}/p360-syllabus%28LIVE%29.html"

echo "Syllabus preview is running at:"
echo "http://127.0.0.1:${port}/p360-syllabus%28LIVE%29.html"
echo
echo "Edit p360-syllabus(LIVE).md, save it, then reload the browser page."
