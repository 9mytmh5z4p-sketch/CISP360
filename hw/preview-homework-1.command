...
if [[ -z "$python_command" ]]; then
  echo "Python 3 is required to preview Homework 1."
...
if [[ "$server_ready" != true ]]; then
  echo "The Homework 1 preview could not be started."
  echo "Press Return to close this window."
  read -r
  exit 1
fi

preview_url="http://127.0.0.1:${port}/hw/Homework%201.html"
open "$preview_url"

echo "Homework 1 preview is running at:"
echo "$preview_url"
echo
echo "Homework 1 is available in the browser at the URL above."
